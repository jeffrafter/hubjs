...
// ==========================================================================
/*global window GLOBAL exports require hub CoreTest Q$ stdout */
...
exports.Runner = {
  ...
  */
  ...
  planDidRecord: function(plan, module, test, assertions, timings) {
    ...
    //   stdout.write(CoreTest.fmt('%@ %@', cur.message, (cur.result || '').toUpperCase()));
    //   if (clean=='dirty') {
    //     this.errors.push(CoreTest.fmt('%@ %@', cur.message, cur.result, (cur.result || '').toUpperCase()));
    //   }
    // }
  }
};
