...
/**
  FIXME: How/why is this different from a normal SC.NestedStore?
...
hub.MergeHub = hub.Hub.extend(
  ...
  */
  ...
  }.property('_currentCommit').cacheable(),
  ...
  */
  ...
  /** @private - adapt for nested store */
  findAll: function(recordType, conditions, params, recordArray, _hub_store) { 
    if (!_hub_store) _hub_store = this;
    return this.get('parentStore').findAll(recordType, conditions, params, recordArray, _hub_store);
  },
