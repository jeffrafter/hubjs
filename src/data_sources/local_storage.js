...
/**
  hub.LocalStorage wraps a SQLite database of serving as a backing store for the 
  ...
  @extends hub.Object
*/
hub.LocalStorage = hub.Object.extend(
  /** @scope hub.LocalStorage */ {
  _hub_name: null,
  _hub_desc: null,
  _hub_db: null,
  ...
  /** 
    ...
    For example:
      ...
      var db = hub.LocalStorage.connect("things");
      db.transaction(
        function(tx) { 
  ...
  */
  transaction: function(callback, onError, onFinish) {
    hub.LocalStorageTransaction.create({ _hub_db: this._hub_db, callback: callback, 
...
/** 
  ...
  @returns {hub.LocalStorage}
*/
hub.LocalStorage.connect = function(name, desc) {
