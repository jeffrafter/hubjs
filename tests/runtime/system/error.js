...
test("hub.E creates an error instance with description,label and code",function(){
  var d = hub.E('This is a new error instance','New Error Instance', "FOO", 99999);
...
test("hub.ok should return true if the passed value is an error object or false", function() {
  ...
  ok(!hub.ok(hub.E("foo")), 'ok(hub.Error) should be false');
