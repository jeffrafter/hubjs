...
test("should return the function for a non-computed property", function() {
  ...
  equals(hub.typeOf(value), hub.T_FUNCTION) ;
});
...
module("object.set()", {
  ...
  setup: function() {
    object = hub.Object.create({
      ...
      // computed property
      _hub_computed: "computed",
      computed: function(key, value) {
        if (value !== undefined) {
          this._hub_computed = value ;
        }
        return this._hub_computed ;
      }.property(),
      ...
      method: function(key, value) {
        if (value !== undefined) {
          this._hub_method = value ;
        }
        return this._hub_method ;
      },
      ...
      // unknown property
      _hub_unknown: 'unknown',
      unknownProperty: function(key, value) {
        if (value !== undefined) {
          this._hub_unknown = value ;
        }
        return this._hub_unknown ;
      }
...
test("should call computed properties passing value and return this", function() {
  ...
  equals(object._hub_computed, "changed") ;
  equals(hub.typeOf(object.computed), hub.T_FUNCTION) ;
  equals(ret, object) ;
});

test("should replace the function for a non-computed property and return this", function() {
  var ret = object.set("method", "changed") ;
  equals(object._hub_method, "method") ; // make sure this was NOT run
  ok(hub.typeOf(object.method) !== hub.T_FUNCTION) ;
  equals(ret, object) ;
});
...
test("should replace prover when property value is null", function() {
  ...
  equals(object._hub_unknown, "unknown"); // verify unknownProperty not called.
  equals(ret, object) ;
});

test("should call unknownProperty with value when property is undefined", function() {
  var ret = object.set("unknown", "changed") ;
  equals(object._hub_unknown, "changed") ;
  equals(ret, object) ;
});
...
module("object.addObserver()", {  
  setup: function() {
    ...
    ObjectC = hub.Object.create({
      
      ObjectE:hub.Object.create({
...
module("object.removeObserver()", {  
  setup: function() {
    ObjectD = hub.Object.create({
      
      ObjectF:hub.Object.create({
        propertyVal:"chainedProperty"
      }),
...
test("changing chained observer object to null should not raise exception", function() {
  ...
  var obj = hub.Object.create({
    foo: hub.Object.create({
      bar: hub.Object.create({ bat: "BAT" })
    })
  });
