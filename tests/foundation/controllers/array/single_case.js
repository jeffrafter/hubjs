...
// // 
// 
// module("hub.ArrayController - single_case - SINGLE", {
//   setup: function() {
...
//   hub.run(function() { controller.removeObject(content); });
...
// // 
// 
// module("hub.ArrayController - single_case - allowsSingleContent=false", {
//   setup: function() {
//     content = TestObject.create({ title: "FOO" });
//     controller = hub.ArrayController.create({ 
