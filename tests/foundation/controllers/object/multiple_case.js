...
// // 
// 
// module("hub.ObjectController - multiple_case - ALLOWSMULTIPLE = false", {
//   setup: function() {
//     src        = hub.Object.create({ foo: "foo1", bar: "bar1" });
//     src2       = hub.Object.create({ foo: "foo2", bar: "bar1" });
//     content    = [src, src2];
...
// // 
// 
// module("hub.ObjectController - multiple_case - ALLOWSMULTIPLE = true", {
//   setup: function() {
//     src        = hub.Object.create({ foo: "foo1", bar: "bar1" });
//     src2       = hub.Object.create({ foo: "foo2", bar: "bar1" });
//     content    = [src, src2];
