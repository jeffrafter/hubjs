...
module("hub.ObjectController - single_case - OBSERVABLE OBJECT", {
  setup: function() {
    content = hub.Object.create({ foo: "foo1", bar: "bar1" });
...
test("changing the content from one to another", function() {
  var callCount = 0 ;
  var content2 = hub.Object.create({ foo: "foo2", bar: "bar2" });
  controller.addObserver("foo", function() { callCount++; });
...
module("hub.ObjectController - single_case - NON-OBSERVABLE OBJECT", {
  setup: function() {
